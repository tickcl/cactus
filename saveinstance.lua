...
do
    ...
    -- Викликаємо finder і зберігаємо результати у таблиці
    local found_methods = finder({
        -- readbinarystring = 'string.find(...,"bin",nil,true)',
    ...
    -- Тепер можна безпечно викликати методи, наприклад:
    if found_methods.protectgui then
        -- приклад виклику
        -- found_methods.protectgui(target_instance)
    end
end
